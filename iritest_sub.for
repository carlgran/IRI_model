...
C
	...
	SUBROUTINE iritest(jm,xlat,xlon,iy,imd,iut,hour,hx,ivar,vbeg,
     &           vend,vstp,piktab,htec_max, jchoice,outf,oar)
...
c ----------- Te ----------------
c uncomment      WRITE(8,4919) XCOR,outf(2,li),outf(3,li),outf(4,li)
c uncomment 4919    FORMAT(F7.1,2X,F6.1,2X,F6.1,2X,F6.1)
c ----------- Ne, TEC ----------------
